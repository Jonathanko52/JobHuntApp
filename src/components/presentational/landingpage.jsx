      ...
      <div className="container">
        <div className="row">
          <div className="text-center col-xs-5 LandingPageLeftCol ">
            <p>
              Thank you, you are now connected with your google account. If this
              is your first time, click on the Create Sheet button below to
              create a spreadsheet that will store all your submitted
            ...
            <p className="mt-3">Your Spreadsheet Id is:{props.spreadSheetId}</p>
            <p className="mt-3">
          ...
          <div className="text-center col-xs-5 LandingPageRightCol ">
            <p>
              If you're a return user, your spreadsheet address should be saved
              to your browser. Otherwise, enter the ID of your spreadsheet below
              to re-link the App.
            </p>
            <input
              onChange={e => {
